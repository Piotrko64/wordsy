...
export const startingWords: Array<WordsType> = [
   ...
   },
   {
      ...
      examplePL: 'Czerwona lampka mrugała na mojej automatycznej sekretarce',
      exampleEN: 'The red light was blinking on my answering machine',
   },
   {
      wordPL: 'kapitał, zasób, zaopatrywać, akcje',
      wordEN: 'stock',
      fav: false,

      examplePL: 'Ta firma zaopatruje mój sklep',
      exampleEN: 'This company stocks my shop',
   },
   {
   ...
   },
   {
      ...
      examplePL:
         'W zeszłym miesiącu para musiała poprosić o pomoc organizację charytatywną',
   ...
   },
   {
      ...
      examplePL:
         'Otrzymałam twoją wiadomość, że nie przyjedziesz na moje uroczyste rozdanie świadectw.',
      exampleEN:
